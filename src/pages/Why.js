    ...
    <main className="why__main">
      <div className="why__section">
        ...
        <div className="why__tldr">
          ...
          <div className="why__textbox--left">
            ...
            <br />
            <a className="why__textlink" href="/">
              Website click on the logo on left top corner &#8599;{" "}
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="why__section">
        ...
        <div className="why__textbox--right grid-2">
          ...
          <br />
          I've read the book "Grid Systems In Graphic Design" but applying it to
          web design is too far fetched. Instead, finding resources of someone
          that has already figured it out was helpful.
          <br />
          <a
            className="why__textlink"
          ...
          Systems In Graphic Design", I realized how much of the design rules
          did not apply to web design. Reading about design grids for newspapers
          and design magazines are a good way to start, knowing where grids and
          the straight "don'ts" come from. In this case, a website that explains
          how a web designer found their methods of how to use grids are 90%
          more applicable to web design; The most important information I
          retrieved during the research is how I should start my web design, how
          font and color selection works, and how to put it all together to
          communicate, create a feeling, and design a website than design books
          and publication. This taught me to read and select what is relevant to
          web design, this is the main goal why I started this project, to sort
          out the most important information and terms for web developers to
          use.
          <br />
          <br />
      ...
      <div className="why__section">
        ...
        <div className="why__textbox--right grid-2">
          ...
          have a lengthy load time. <br />
          — Used solutions and services: Google Fonts API + Web font loader +
          JSON file of font combinations that are recommended and generated by
          other sources.
          <br />
          <br />
          Color scheme — Let the user see color combos. The selected combo will
          be used to color a chosen design.
          <br /> — Used solutions and services: Colormind. This service was
          fetched and then saved in a JSON database, as this page was not
          secure, and a mixed content error occurred. To solve this, with the
          secured https I deployed my site with. A static local database was a
          simple solution for the MVP.
          <br />
          <details>
        ...
        <div className="why__textbox--right grid-2">
          ...
          <ul>
            ...
            <li>
              ...
              the same design. I had to design the two variants and then focus
            ...
            <li>
              ...
              content is and how it could attack users. The api I was using came
              from a non secure website so I had to think of an another soltion.
              The async functions were also new to me in react, the state of an
              async function was solved, but the mixed content stopped me from
              working directly with the api. Instead, I retrieved data from the
              api and stored it in a local JSON file.
            </li>
            <li>
              ...
              adding functionality. This was a new development lesson I had to
              learn as the project were not that long and couldn't let us
              realize what we've build could be a un future proof way of
              programming it.
            </li>
            <li>
      ...
      <div className="why__section">
        ...
        <div className="why__textbox--left grid-2">
          <ul>
            <li>
              Planning more in depth for each component, even if the component
              seems small. It would have benefitted me in having a smoother
              development process and more straightforward components to build.
              Not having to restructure the architecture and styling would save
              some time for further development.{" "}
            </li>
            <li>
              I'm still not clear if I should develop the project by component
              or focus on similarties within each component. But whatever you
              do, try not to combine them. Having an unclear structure of how
              you develop things could easily make you overwhelmed. Writing
              todos down as you go makes it easier to focus on the task at hand.{" "}
            </li>
            <li>
        ...
        <div className="why__textbox--right grid-2">
          <ul>
            <li>
              Developing all of the core concepts and techniques early on so the
              biggest technical difficulties wount hinder you during the
              development.
            </li>
            <li>
              Test for all the devices after every significant change or push to
              github, to both layout or functionality aspects.
            </li>
            <li>
              Have the full environment prepared from the start. Having the
              platform to check the changes I've made, to be able to test the
              project live on any device, and to be able to see the uploads from
              the early stage to the MVP was really rewarding.
            </li>
            <li>
              Having people you can test your early MVP prototype. It's good to
              have new people testing each time.
            </li>
          </ul>
        </div>
      </div>
